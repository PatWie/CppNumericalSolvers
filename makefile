CXX=g++
CXXFLAGS := -Wall -Wextra -pedantic-errors -std=c++11 -fopenmp -O3 -isystem gtest/include  -isystem eigen
CXXFLAGSTEST := -Wall -Wextra -pedantic-errors -std=c++11 -fopenmp -O3 -isystem gtest/include  -isystem eigen  -DNDEBUG

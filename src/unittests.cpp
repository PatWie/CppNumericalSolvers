...
TEST(GradientDescentTest, RosenbrockNear)  { SOLVE_1stOrder(pwie::GradientDescentSolver, rosenbrock, 1.0, 3.0, 0.0) }

TEST(ConjugateGradientTest, RosenbrockFar) { SOLVE_1stOrder(pwie::ConjugateGradientSolver, rosenbrock, 15.0, 8.0, 0.0) }
TEST(ConjugateGradientTest, RosenbrockNear){ SOLVE_1stOrder(pwie::ConjugateGradientSolver, rosenbrock, 1.0, 3.0, 0.0) }

TEST(NewtonDescentTest, RosenbrockFar)     { SOLVE_2ndOrder(pwie::NewtonDescentSolver, rosenbrock, 15.0, 8.0, 0.0) }
TEST(NewtonDescentTest, RosenbrockNear)    { SOLVE_2ndOrder(pwie::NewtonDescentSolver, rosenbrock, 1.0, 3.0, 0.0) }

TEST(BfgsTest, RosenbrockFar)              { SOLVE_1stOrder(pwie::BfgsSolver, rosenbrock, 15.0, 8.0, 0.0) }
TEST(BfgsTest, RosenbrockNear)             { SOLVE_1stOrder(pwie::BfgsSolver, rosenbrock, 1.0, 3.0, 0.0) }
